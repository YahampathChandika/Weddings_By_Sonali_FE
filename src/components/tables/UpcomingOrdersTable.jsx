...
import { useDeleteOrderMutation, useGetOrderMatricesQuery, useGetOrdersByStateQuery } from "../../store/api/orderApi";
...
export default function UpcomingOrdersTable() {
  ...
  const { data: orders, refetch: refetchOrders } = useGetOrdersByStateQuery(2);
